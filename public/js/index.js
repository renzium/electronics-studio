(function () {
    ...
    var API_KEY = 'cfPFc6yRRNW9KnRBLuvWtg';
     ...
     */
    var API_SECRET = 'dWsMvHNNfECAIjVjS4IYBg6MdKrdlnkes9Uo';
        ...
        ZoomMtg.init({
            ...
            success: function () {
                ZoomMtg.join({
                    ...
                    success: function (res) {
                        https: //source.zoom.us/zoom-meeting-1.7.7.min.js://source.zoom.us/zoom-meeting-1.7.7.min.js     $('#nav-tool').hide();
